    ...
    <div class="card-body pt-0">
        <div class="table-responsive">
            <table class="table datatable" id="datatable_1">
                ...
                <tbody>
                    <tr v-for="service in services_data" :key="service.id_service" @click="checkService(service.id_service)">
                        <td style="width: 16px;">
    ...
    <div class="col-5">
    <CreateService @serviceAdded="handleServiceAdded" v-if="!updating" />
    <UpdateService @serviceUpdated="handleServiceAdded" @cancelUpdate="handleCancelUpdate" :service="updated_service" v-if="updating" />
    </div>
    </div>
    </template>
